  ...
  return (
    <CheckboxPrimitive.Indicator forceMount asChild>
      <motion.svg
        ...
        fill="none"
        // Upstream registry bug: this shipped as "0 24" (only 2 of the
        // required 4 numbers) — Chromium logs a viewBox parse error and
        // falls back to intrinsic sizing. Fixed to the standard 24x24
        // icon viewBox the checkmark path is actually drawn against.
        viewBox="0 0 24 24"
        strokeWidth="3.5"
        stroke="currentColor"
        initial="unchecked"
